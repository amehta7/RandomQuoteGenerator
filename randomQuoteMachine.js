...
function quoteGenerator() {
  var randQut = quotes[Math.floor(Math.random() * quotes.length)]
  document.getElementById('text').innerText = randQut.text
  document.getElementById('author').innerText = randQut.source
}
